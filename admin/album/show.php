                  ...
                  <tr>
                    ...
                    <td>
                      <?php if (!empty($albumData['cover_image'])) : ?>
                        <img src="<?php echo "../../uploads/album/{$yearData['fiscal_year']}/cover_images/{$albumData['cover_image']}"; ?>" alt="" style="height: 80px; width: 120px; object-fit: cover;">
                      <?php else : ?>
                        Image Not Found
                      <?php endif; ?>
                    </td>
          ...
          <div class="card card-warning">
            ...
            <div class="px-4 pt-2 d-flex justify-content-between align-items-center gap-2" style="width:100%;">
              ...
              <div class=" d-flex justify-content-end align-items-center" style="width:100%;">
                <a href="<?= "../gallery/add.php?albumID={$albumData['id']}" ?>" type="button" class="btn btn-primary btn-sm">+Add More Images/Videos</a>
                <a href="<?= "../gallery/listing.php?#album{$albumData['id']}" ?>" class="btn btn-dark btn-sm mx-2">view
                  in
                  gallery</a>
                <button type="button" class="btn btn-success btn-sm mx-2" onclick="activateSelectedAlbumImages()">Active</button>
                <button type="button" class="btn btn-danger btn-sm" onclick="blockselectedAlbumImages()">Block</button>
                <button type="button" class="btn btn-danger btn-sm mx-2" style="background-color:#FD7E14;" onclick="deleteSelectedAlbumImages()">Delete</button>
              </div>
            ...
            <div class="card-body">
              <?php if (!empty($albumImagesByAlbumId)) : ?>
                <table id="sortable" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th class="position-relative"># <input type="checkbox" class="all-album-images-checkbox position-absolute" style="top:50%;left:50%;" onchange="selectAllAlbumImages(this)"></th>
                  ...
                  <tbody>
                    <?php foreach ($albumImagesByAlbumId as $index => $albumImage) : ?>
                      <tr id="<?= $albumImage['id'] ?>" data-sort-id="<?= $albumImage['id'] ?>">
                        <td class="position-relative px-4"><input type="checkbox" class="album-image-checkbox position-absolute" style="top:50%;left:50%;" value="<?php echo $albumImage['id']; ?>"></td>
                        ...
                        <td class="align-middle text-center">
                          <?php if ($albumImage['type'] == '1') : ?>
                            <?php if (!empty($albumImage['album_image'])) : ?>
                              <img src="<?php echo "../../uploads/album/{$yearData['fiscal_year']}/album_images/{$albumImage['album_image']}"; ?>" alt="" style="height: 58px; width: 71px; object-fit: cover;">
                            <?php else : ?>
                              Image Not Found
                            <?php endif; ?>
                          <?php else : ?>
                        ...
                        <td class="align-middle text-center">
                          <?php echo $albumImage['status'] == 1 ? 'Active' : 'Blocked'; ?></td>
                        <td align="center" class="align-middle text-center"> <a href="<?= "../gallery/edit.php?imageID={$albumImage['id']}" ?>" type="button" class="btn btn-warning btn-sm">edit</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
